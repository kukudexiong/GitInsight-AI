...
export default function DashboardInline({ data }: Props) {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-3 mb-5">
        <StatCard label="7天提交" value={data.stats.total_commits_30d} />
        <StatCard label="活跃贡献者" value={data.stats.active_authors} color="text-[var(--color-success)]" />
        <StatCard label="热点文件" value={data.stats.hot_files_count} color="text-[var(--color-warning)]" />
        <StatCard label="高风险文件" value={data.stats.risk_files_count} color="text-[var(--color-danger)]" />
      </div>
